...
<body>
	...
	<c:if test="${message eq null }">
		<div class="center">
			<table
				style="border: 0; width: 80%; text-align: center; display: inline-block;">
				<tr>
					...
					<td colspan="3" align="left">
						<table class="normal">
							<c:forEach items="${book.reviews}" var="review">
								<tr>
									<td align="left"><c:forTokens items="${review.stars}"
											delims="," var="star">
											<c:if test="${star eq 'on'}">
												<img src="images/rating_on.png" />
											</c:if>
								...
								<tr>
									<td align="left">By ${review.customer.fullname} On
